...
public class App extends Application {
    ...
    private String globalstrNickname,globalstrProfile,globalstrEmail,globalstrAgeRange,globalstrGender;
    public String getstrNickname()
    {
        return globalstrNickname;
    }
    public String getstrProfile()
    {
        return globalstrProfile;
    }
    public String getstrEmail()
    {
        return globalstrEmail;
    }
    public String getstrAgeRange()
    {
        return globalstrAgeRange;
    }
    public String getstrGender()
    {
        return globalstrGender;
    }

    public void setstrNickname(String data)
    {
        this.globalstrNickname = data;
    }
    public void setstrProfile(String data)
    {
        this.globalstrProfile = data;
    }
    public void setstrEmail(String data)
    {
        this.globalstrEmail = data;
    }
    public void setstrAgeRange(String data)
    {
        this.globalstrAgeRange = data;
    }
    public void setstrGender(String data)
    {
        this. globalstrGender = data;
    }
